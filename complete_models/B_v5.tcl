# 20191006 - B_v5.tcl - Re-spinning up Scenario B with mask, adding CLM
# overland flow on
# modified from B_v4.tcl
# DETAILS:
...
# ParFlow Inputs
#file copy -force "../indicator_files/B_indicator.pfb" .
...
pfset GeomInput.indi_input.GeomNames      "s1 s2"
pfset Geom.indi_input.FileName            "B_indicator.pfb"
#
...
#-----------------------------------------------------------------------------
pfset Geom.Perm.Names                     "domain s1 s2"
...
# Layers 1 through 16 (bedrock) have K = 4.99e-7 m/s
pfset Geom.s1.Perm.Type               Constant
pfset Geom.s1.Perm.Value              0.00179645

# Top 4 layers have K = 3.5e-5 m/s
pfset Geom.s2.Perm.Type               Constant
pfset Geom.s2.Perm.Value              0.126
...
pfset Geom.Porosity.GeomNames             "domain s1 s2"
...
pfset Geom.s2.Porosity.Value   0.30
...
pfset Geom.domain.ICPressure.FileName				B_v4.out.press.01042.pfb
...
pfset ComputationalGrid.NZ                20
pfdist B_v4.out.press.01042.pfb

# pfset ComputationalGrid.NX                91
# pfset ComputationalGrid.NY                70
# pfset ComputationalGrid.NZ                20
pfdist B_indicator.pfb
