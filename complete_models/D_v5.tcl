# 20191015 - D_v5.tcl - spun-up Scenario D to generate outputs for EcoSLIM
# overland flow off
# modified from D_v4.tcl (there is no v1 or v2)
# DETAILS:
...
pfset Geom.domain.ICPressure.FileName				D_v4.out.press.01042.pfb
...
pfset ComputationalGrid.NZ                20
pfdist D_v4.out.press.01042.pfb
