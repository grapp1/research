# 20190617 - spinup6.tcl - spinning up model with K = 1e-6 m/hr
# overland flow on
# modified from o_spinup5.tcl
# DETAILS:
...
# 20190617 updated K to be equivalent to 10^-6 m/s
...
pfset TimingInfo.StopTime        20000.0
pfset TimingInfo.DumpInterval    1000
pfset TimeStep.Type              Growth
pfset TimeStep.InitialStep       20
...
pfset Patch.z-lower.BCPressure.Type		      OverlandFlow
pfset Patch.z-lower.BCPressure.Cycle		      "constant"
pfset Patch.z-lower.BCPressure.alltime.Value	      1.75e-5
...
pfset Patch.z-upper.BCPressure.alltime.Value	      -1.75e-5
...
pfset ICPressure.GeomNames							domain
pfset Geom.domain.ICPressure.RefPatch               z-upper
pfset Geom.domain.ICPressure.FileName				gr_sp6_RESTART.out.press.00044.pfb
...
pfset ComputationalGrid.NZ                20
pfdist gr_sp6_RESTART.out.press.00044.pfb
