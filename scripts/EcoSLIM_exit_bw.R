...
exit_pts <- dem_fig + geom_point(data = exited_particles, aes(x=X, y=Y, colour = age)) + labs(color = "Age (days)") +
  #scale_fill_continuous(limits = c(0,40000), breaks = c(0, 10000, 20000, 30000, 40000)) +
  ggtitle("Locations and ages of exited particles for A_v1 - backward tracking with 10k particle pulse")
exit_pts
